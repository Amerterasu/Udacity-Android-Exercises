...
public class MainActivity extends AppCompatActivity {
    ...
    public void onClickShareTextButton(View v) {
        ...
        String shareText = "giving some love";
    ...
    private void shareText(String text){
        ...
        Intent shareIntent = ShareCompat.IntentBuilder.from(this).setChooserTitle(title).setType(mimeType).setText(text).createChooserIntent();
